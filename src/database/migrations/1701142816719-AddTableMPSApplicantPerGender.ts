...
export class AddTableMPSApplicantPerGender1701142816719
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.createTable(
      new Table({
        name: 'tbl_mps_applicantpergender',
        columns: [
          {
            name: 'id',
            type: 'bigint',
    ...
    await queryRunner.createForeignKeys('tbl_mps_applicantpergender', [
      new TableForeignKey({
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropTable('tbl_mps_applicantpergender');
  }
}
