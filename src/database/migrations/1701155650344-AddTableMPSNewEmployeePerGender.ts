...
export class AddTableMPSNewEmployeePerGender1701155650344
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.createTable(
      new Table({
        name: 'tbl_mps_newemployeepergender',
        columns: [
          {
            name: 'id',
            type: 'bigint',
    ...
    await queryRunner.createForeignKeys('tbl_mps_newemployeepergender', [
      new TableForeignKey({
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropTable('tbl_mps_newemployeepergender');
  }
}
