...
import { TableNewEmployeePerGenderDto } from './dto/table-mps-newemployeepergender.dto';
...
@Entity('tbl_mps_newemployeepergender')
@UseDto(TableNewEmployeePerGenderDto)
export class TableNewEmployeePerGender extends AbstractEntity<TableNewEmployeePerGenderDto> {
